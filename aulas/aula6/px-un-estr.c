...
int main() {
  ...
  union RGBAPixel *pixels = (union RGBAPixel *)imagem2;
  ...
  pixels = (union RGBAPixel *) imagem3;

  for (int y = 0; y < 10*10; y++) {
    int media = round((pixels[y].rgba.b+pixels[y].rgba.g+pixels[y].rgba.r)/3.0);
    pixels[y].rgba.b = media;
    pixels[y].rgba.g = media;
    pixels[y].rgba.r = media;
  }
  ...
  pixels = (union RGBAPixel *)imagem4;
