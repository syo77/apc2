...
int main() {
  ...
  for(int col = 0; col < 10; col++) {
   if (lin==col) {
      pchar3[(lin * 10 * 4) + (col * 4) + 3] = 0;
      pchar3[(lin * 10 * 4) + (col * 4) + 2] = 0;
      pchar3[(lin * 10 * 4) + (col * 4) + 1] = 255;

      pchar3[(linf * 10 * 4) + (col * 4) + 3] = 0;
      pchar3[(linf * 10 * 4) + (col * 4) + 2] = 0;
      pchar3[(linf * 10 * 4) + (col * 4) + 1] = 255;
